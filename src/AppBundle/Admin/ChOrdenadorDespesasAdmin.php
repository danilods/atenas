...
class ChOrdenadorDespesasAdmin extends AbstractAdmin{
    //put your code here
   // protected $emName = 'unidade';
	 protected $baseRouteName = 'os_cenipa_chefe';
     protected $baseRoutePattern = 'page-chefe-cenipa';
    ...
    $user = $this->getConfigurationPool()->getContainer()->get('security.context')->getToken()->getUser();
        ...
        $query
			  ...
			  ->andWhere($query->getRootAliases()[0]. '.statusOs = :status ')
			  
			  ->setParameter('omPagadora', 1)
			  
			  ->setParameter('status', 'CONFIRMADA');
