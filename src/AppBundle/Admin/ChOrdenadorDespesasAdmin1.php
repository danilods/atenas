...
class ChOrdenadorDespesasAdmin1 extends AbstractAdmin{
    //put your code here
   // protected $emName = 'unidade';
	 protected $baseRouteName = 'os1_cenipa_chefe';
     protected $baseRoutePattern = 'page1-chefe-cenipa';
