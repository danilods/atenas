...
class ChOrdenadorDespesasAdmin2 extends AbstractAdmin{
    //put your code here
   // protected $emName = 'unidade';
	 protected $baseRouteName = 'os2_cenipa_chefe';
     protected $baseRoutePattern = 'page2-chefe-cenipa';
