...
class ChOrdenadorDespesasAdmin3 extends AbstractAdmin{
    //put your code here
   // protected $emName = 'unidade';
	 protected $baseRouteName = 'os3_cenipa_chefe';
     protected $baseRoutePattern = 'page3-chefe-cenipa';
    ...
    $user = $this->getConfigurationPool()->getContainer()->get('security.context')->getToken()->getUser();
        ...
        $query
			  ->where('o.omPagadora = :omPagadora')
			  ->andWhere($query->getRootAliases()[0]. '.statusPassagem = :status ')
			  
			  ->setParameter('omPagadora', 4)
        ...
        $formMapper
            ...
            ->add('statusOs', 'choice', array(
                'choices' => array(
					...
					'AUTORIZADA' => 'AUTORIZAR ORDEM DE SERVIÇO',
            ...
            ->add('statusPassagem', 'choice', array(
                'choices' => array(
                    ...
                    '1' => 'PEDIDO DE PASSAGEM SOLICITADA PELO USUÁRIO',
					'2' => 'PEDIDO DE PASSAGEM AUTORIZADA PELO CH SERIPA',
					'3' => 'AUTORIZAR EMISSÃO DE PASSAGEM'
