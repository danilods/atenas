...
class ChOrdenadorDespesasAdmin4 extends AbstractAdmin{
    //put your code here
   // protected $emName = 'unidade';
	 protected $baseRouteName = 'os4_cenipa_chefe';
     protected $baseRoutePattern = 'page4-chefe-cenipa';
