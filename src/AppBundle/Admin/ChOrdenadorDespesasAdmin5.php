...
class ChOrdenadorDespesasAdmin5 extends AbstractAdmin{
    //put your code here
   // protected $emName = 'unidade';
	 protected $baseRouteName = 'os5_cenipa_chefe';
     protected $baseRoutePattern = 'page5-chefe-cenipa';
