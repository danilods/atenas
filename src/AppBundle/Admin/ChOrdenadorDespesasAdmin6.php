...
class ChOrdenadorDespesasAdmin6 extends AbstractAdmin{
    //put your code here
   // protected $emName = 'unidade';
	 protected $baseRouteName = 'os6_cenipa_chefe';
     protected $baseRoutePattern = 'page6-chefe-cenipa';
