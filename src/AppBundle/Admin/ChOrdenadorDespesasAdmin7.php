...
class ChOrdenadorDespesasAdmin7 extends AbstractAdmin{
    //put your code here
   // protected $emName = 'unidade';
	 protected $baseRouteName = 'os7_cenipa_chefe';
     protected $baseRoutePattern = 'page7-chefe-cenipa';
