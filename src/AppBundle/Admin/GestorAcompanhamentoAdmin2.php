...
class GestorAcompanhamentoAdmin2 extends AbstractAdmin{
    //put your code here
    // protected $emName = 'unidade';
    use AdminExtraExportTrait;

    protected $baseRouteName = 'acompanhamento_seripa2';
    protected $baseRoutePattern = 'page-acompanhamento-seripa2';
