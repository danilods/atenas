...
class GestorAcompanhamentoAdmin3 extends AbstractAdmin{
    //put your code here
    // protected $emName = 'unidade';
    use AdminExtraExportTrait;

    protected $baseRouteName = 'acompanhamento_seripa3';
    protected $baseRoutePattern = 'page-acompanhamento-seripa3';
