...
class GestorAcompanhamentoAdmin4 extends AbstractAdmin{
    //put your code here
    // protected $emName = 'unidade';
    use AdminExtraExportTrait;

    protected $baseRouteName = 'acompanhamento_seripa4';
    protected $baseRoutePattern = 'page-acompanhamento-seripa4';
