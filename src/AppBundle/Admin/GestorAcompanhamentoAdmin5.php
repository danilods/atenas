...
class GestorAcompanhamentoAdmin5 extends AbstractAdmin{
    //put your code here
    // protected $emName = 'unidade';
    use AdminExtraExportTrait;

    protected $baseRouteName = 'acompanhamento_seripa5';
    protected $baseRoutePattern = 'page-acompanhamento-seripa5';
