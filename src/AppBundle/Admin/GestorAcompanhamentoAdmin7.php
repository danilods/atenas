...
class GestorAcompanhamentoAdmin7 extends AbstractAdmin{
    //put your code here
    // protected $emName = 'unidade';
    use AdminExtraExportTrait;

    protected $baseRouteName = 'acompanhamento_seripa7';
    protected $baseRoutePattern = 'page-acompanhamento-seripa7';
     ...
     $formMapper
            ...
            ->add('statusOs', 'choice', array(
                'choices' => array(
					...
					'CONFIRMADA' => 'ORDEM DE SERVIÇO CONFIRMADA PELO SETOR ADMINISTRATIVO',
					'ANALISADA' => 'ENCAMINHAR AO CHEFE DO SERIPA',
                    'AUTORIZADA' => 'ORDEM DE SERVIÇO AUTORIZADA PELO CH DO SERIPA',
            ...
            ->add('statusPassagem', 'choice', array(
                'choices' => array(
                    ...
                    '1' => 'PEDIDO DE PASSAGEM SOLICITADO PELO USUÁRIO(PENDENTE DE ENVIO AO CENIPA)',
                    '2' => 'PEDIDO DE PASSAGEM ENVIADO AO CENIPA',
