...
class GestorAcompanhamentoCenipaAdmin1 extends AbstractAdmin{
    //put your code here
    // protected $emName = 'unidade';
    use AdminExtraExportTrait;

   protected $baseRouteName = 'acompanhamento_cenipa_gestor_1';
    protected $baseRoutePattern = 'page-gestor-cenipa-acompanhamento-seripa1';
