...
class GestorAcompanhamentoCenipaAdmin2 extends AbstractAdmin{
    //put your code here
    // protected $emName = 'unidade';
    use AdminExtraExportTrait;

    protected $baseRouteName = 'acompanhamento_cenipa2';
    protected $baseRoutePattern = 'page-gestor-acompanhamento-cenipa2';
