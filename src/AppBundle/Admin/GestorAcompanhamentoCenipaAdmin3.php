...
class GestorAcompanhamentoCenipaAdmin3 extends AbstractAdmin{
    //put your code here
    // protected $emName = 'unidade';
    use AdminExtraExportTrait;

    protected $baseRouteName = 'acompanhamento_cenipa3';
    protected $baseRoutePattern = 'page-gestor-acompanhamento-cenipa3';
