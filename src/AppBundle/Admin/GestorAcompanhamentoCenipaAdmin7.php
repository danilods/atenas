...
class GestorAcompanhamentoCenipaAdmin7 extends AbstractAdmin{
    //put your code here
    // protected $emName = 'unidade';
    use AdminExtraExportTrait;

    protected $baseRouteName = 'acompanhamento_cenipa7';
    protected $baseRoutePattern = 'page-gestor-acompanhamento-cenipa7';
