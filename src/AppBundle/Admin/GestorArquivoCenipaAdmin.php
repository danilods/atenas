...
class GestorArquivoCenipaAdmin extends AbstractAdmin{
    //put your code here
    // protected $emName = 'unidade';
    use AdminExtraExportTrait;

    protected $baseRouteName = 'arquivo_cenipa';
    protected $baseRoutePattern = 'page-arquivo-cenipa';
   ...
   public function preUpdate($object) {
        ...
        foreach ($object->getRoteiro() as $roteiro) {
			...
			if($i== 1){
				...
				$idaPeriodo = $dataInicio;
				$horaInicioPeriodo = $horaIni;
			...
			//$totalDiarias;
                 ...
                 if($__quantidade_diarias==0.5){
					...
					$calculoAuxilio = $this->calcularAuxilio($idUser, $quantidadeDiasUteisRoteiro, $desconto);						
		...
		public function calcularAuxilio($idUsuario, $diasUteis, $descontoAuxilio){
				...
				$valorAlimentacaoRoteiro = $diarioAlimentacao * $diasUteisAlimentacao;
				
				$valorTransporteRoteiro = $diarioTransporte * $diasUteis;
