...
class GestorSeripa4Admin extends AbstractAdmin{
    //put your code here
   // protected $emName = 'unidade';
   protected $baseRouteName = 'ordem_missao_seripa4';
   protected $baseRoutePattern = 'page-gestor-seripa4';
           ...
           ->add('statusOs', 'choice', array(
            ...
            ->add('statusPassagem', 'choice', array(
                'choices' => array(
                    ...
                    '1' => 'PEDIDO DE PASSAGEM SOLICITADA PELO USUÁRIO. ENCAMINHAR PEDIDO AO CH SERIPA',
  ...
  public function prePersist($object) {
	 ...
	 public function preUpdate($object) {
        ...
        $unidade = $object->getOmPagadora()->getId();
				  ...
				  foreach ($object->getAeroporto() as $aeroporto) {
					...
					foreach ($object->getRoteiro() as $roteiro) {
						...
						$emRot = $this->getModelManager()->getEntityManager('AppBundle\Entity\RoteiroMissao');
		...
		public function getRoteirosComPernoite($idOs){
				...
				//demais roteiros
				...
				}elseif(count($roteirosComPernoite)==0){//entao roteiro nao tem pernoite
					...
					$roteiroSemPernoite = $queryRot3->getResult();
					
					return array($roteiroSemPernoite[0], 0);
				}
