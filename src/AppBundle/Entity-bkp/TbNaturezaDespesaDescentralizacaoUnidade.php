...
class TbNaturezaDespesaDescentralizacaoUnidade
{
     ...
     *
     * @param \AppBundle\Entity\TbTaxonomiaNaturezaDespesa $tbNaturezaDespesa
     *
     * @return TbNaturezaDespesaDescentralizacaoUnidade
     */
    public function setTbNaturezaDespesa(\AppBundle\Entity\TbTaxonomiaNaturezaDespesa $tbNaturezaDespesa = null)
    {
