 ...
 * FosUserUser
 *
 * @ORM\Table(name="fos_user_user", uniqueConstraints={@ORM\UniqueConstraint(name="UNIQ_C560D76192FC23A8", columns={"username_canonical"}), @ORM\UniqueConstraint(name="UNIQ_C560D761A0D96FBF", columns={"email_canonical"})}, indexes={@ORM\Index(name="setor_divisao_id", columns={"setor_divisao_id"}), @ORM\Index(name="posto_graduacao_id", columns={"posto_graduacao_id"})})
 * @ORM\Entity
 */
class FosUserUser
{
     ...
     * @var integer
     *
     * @ORM\Column(name="setor_divisao_id", type="integer", nullable=false)
     */
    private $setorDivisaoId;

    /**
     * @var integer
     *
     * @ORM\Column(name="posto_graduacao_id", type="integer", nullable=false)
     */
    private $postoGraduacaoId;
     ...
     * Set setorDivisaoId
     *
     * @param integer $setorDivisaoId
     *
     * @return FosUserUser
     */
    public function setSetorDivisaoId($setorDivisaoId)
    {
        $this->setorDivisaoId = $setorDivisaoId;
     ...
     * @return integer
     */
    public function getSetorDivisaoId()
    {
        return $this->setorDivisaoId;
    }

    /**
     * Set postoGraduacaoId
     *
     * @param integer $postoGraduacaoId
     *
     * @return FosUserUser
     */
    public function setPostoGraduacaoId($postoGraduacaoId)
    {
    ...
    /**
     * Get postoGraduacaoId
     *
     * @return integer
     */
    public function getPostoGraduacaoId()
    {
        return $this->postoGraduacaoId;
    }
}
