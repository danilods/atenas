...
class TbUsuario
{
    ...
    private $tipoAtividade;
     ...
     /**
     * @var string
     * @Assert\NotBlank(message="Por favor, forneça os números")
     * @Assert\Length(
     *     min=11,
     *     max=11,
     *     minMessage="Campo cpf deve possuir 11 dígitos",
     *     maxMessage="Campo cpf deve possuir 11 dígitos"
     * )
     * @Assert\Regex(
     *     pattern="/^[0-9]+$/",
     ...
     * @var boolean
     *
     * @ORM\Column(name="solicitacao_gabaer", type="boolean", nullable=false)
     */
     private $solicitacaoGabaer;

     /**
     * @var boolean
     *
     * @ORM\Column(name="diarias_excedidas", type="boolean", nullable=false)
     */
     private $diariasExcedidas;

     /**
     * @var decimal
     *
     * @ORM\Column(name="total_ano", type="decimal", nullable=true)
     */
     private $totalAno;
     ...
     * @var decimal
     *
     * @ORM\Column(name="auxilio_transporte", type="decimal", nullable=true)
     */
     ...
     * @var decimal
     *
     * @ORM\Column(name="auxilio_alimentacao", type="decimal", nullable=true)
     */
     ...
     * Set ativo
     *
     * @param boolean $solicitacaoGabaer
     *
     * @return TbUsuario
     */
    public function setSolicitacaoGabaer($solicitacaoGabaer)
    {
        $this->solicitacaoGabaer = $solicitacaoGabaer;
     ...
     * @return boolean
     */
    public function getDiariasExcedidas()
    {
        return $this->diariasExcedidas;
    }
     ...
     * Set ativo
     *
     * @param boolean $diariasExcedidas
     *
     * @return TbUsuario
     */
    public function setDiariasExcedidas($diariasExcedidas)
    {
        $this->diariasExcedidas = $diariasExcedidas;
     ...
     * @return boolean
     */
    public function getSolicitacaoGabaer()
    {
        return $this->solicitacaoGabaer;
    }
     ...
     * Set totalDiarias
     *
     * @param decimal $totalDiarias
     *
     * @return TbUsuario
     */
    public function setTotalAno($totalDiarias)
    {
        $this->totalAno = $totalDiarias;
     ...
     * @return decimal
     */
    public function getTotalAno()
    {
        return $this->totalAno;
    }
	
	public function __toString(){
		return $this->getTbPostoGraduacao().'  '.$this->getNome();
	}
